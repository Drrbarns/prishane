                    ...
                    <div className="space-y-6">
                        ...
                        <SectionCard title="Social Media" icon="ri-share-line" description="Links to your social media profiles">
                            <div className="grid md:grid-cols-2 gap-5">
                                ...
                                <FieldGroup label="WhatsApp Number"><input type="text" value={val('social_whatsapp')} onChange={e => set('social_whatsapp', e.target.value)} className={inputClass} placeholder="0595211414" /></FieldGroup>
                            </div>
                        </SectionCard>
                    </div>
                );
                ...
                return (
                    <div className="space-y-6">
                        <SectionCard title="Search Engine Optimization" icon="ri-search-eye-line" description="Improve how your site appears in search results">
                            <FieldGroup label="Site Title" description="The default <title> tag when no page-specific title exists"><input type="text" value={val('seo_title')} onChange={e => set('seo_title', e.target.value)} className={inputClass} placeholder="Prishane Hair - Premium Hair &amp; Wigs" /></FieldGroup>
